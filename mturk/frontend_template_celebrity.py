...
<div id="instruction-container">
    <div class="instructions-content">
        ...
        <div class="example">
            <p>To illustrate, consider the following public figure:</p>
            <p><img src="https://tot-mturk-instruction-images.s3.amazonaws.com/taylor_swift.png" max-width="150" height="210"/></p>
            <p><strong>This is an example of a GOOD ToT information request:</strong></p>
            <p>
                <em>
                She used to be my favorite singer-songwriter when I was a teenager.
                In her early days, she used to release lots of country songs and lots of them were considered worldwide hits.
                If I remember correctly, she was born somewhere in Pennsylvania, and she mentions the city from time to time in her lyrics.
                Also, I remember that at some point she was awarded several Grammy awards, but I’m not sure about this.
                As far as I know, she had some troubles with her record company, so she had to switch to another one.
...
<div id="movie-name-container" class="hidden">
    <p>Do you remember the name of the person?</p>
...
<div id="movie-name-input-container" class="hidden">
    <p><strong>Please write the name of the person:</strong></p>
    <crowd-input id="movie-name-input" name="movie-name" label="Type the name here..."></crowd-input>
    <button type="button" id="go-back-from-movie-name-input">Go Back</button>
    <button type="button" id="submit-movie-name-button">Submit Name</button>
</div>
...
<div id="confirm-container" class="hidden">
    ...
    <p>Does this Wikipedia page describe the person you recalled?</p>
