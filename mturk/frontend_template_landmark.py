...
<div id="instruction-container">
    <div class="instructions-content">
        <p>
            ...
            You will be shown a series of images of specific places.
            They might correspond to tourist attractions, buildings, ancient sites, etc.
            We refer to such places as "landmarks".
            While you go through each image, see if you recognize the landmark.
            If you recognize the landmark, we will ask if you remember the name.
            If you recognize the landmark, but <b>DO NOT</b> remember the name, then you are in a <b>"Tip of the Tongue" (ToT)</b> state.
        ...
        <div class="example">
            <p><strong>To illustrate, consider the following landmark:</strong></p>
            <p><img src="https://tot-mturk-instruction-images.s3.amazonaws.com/Eiffel-Tower.jpeg" width="160" height="110"/></p>
            <p><strong>This is an example of a GOOD ToT information request:</strong></p>
            <p>
                <em>
                I saw this landmark when I was 12 years old when I was travelling around Paris.
                It was a giant steel tower in the center of the city if I remember correctly.
                Also, I remember that it was glowing during the night and many people were chilling in the park next to that tower,
                but I don't recall the name of it. I think there’s also a scene in one of the old superman movies (with Christopher Reeves)
                that happens on this tower. What's the name of the tower??
                </em>
            </p>
        </div>
        <div class="example">
            ...
            <p>
                <em>It was a big tower in France.</em>
            </p>
        </div>
    </div>
...
<div id="image-container" class="hidden">
    <div class="flex-container">
        ...
        <div class="text-button-wrapper">
            <p>Do you recognize this landmark?</p>
...
<div id="movie-name-container" class="hidden">
    <p>Do you remember the name of the landmark?</p>
...
<div id="movie-name-input-container" class="hidden">
    <p><strong>Please input the name of the landmark:</strong></p>
    <crowd-input id="movie-name-input" name="movie-name" label="Type the landmark name here..."></crowd-input>
    <button type="button" id="go-back-from-movie-name-input">Go Back</button>
    <button type="button" id="submit-movie-name-button">Submit Landmark Name</button>
</div>
...
<div id="confirm-container" class="hidden">
    ...
    <p>Does this Wikipedia page describe the landmark you recalled?</p>
