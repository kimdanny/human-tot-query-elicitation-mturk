...
question_sample = open("version_2.xml", "r").read()
...
response = client.create_hit(
    MaxAssignments=10,
    LifetimeInSeconds=2630000,
    AssignmentDurationInSeconds=600,
    Reward=mturk_environment["reward"],
    Title="Write your tip of the tongue query",
    Keywords="tip of the tongue, movie, title",
    Description="Write your tip of the tongue query",
